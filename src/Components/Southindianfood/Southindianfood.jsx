...
export default function Southindianfood() {
    return (
        <div className='south'>
            ...
            <div className="Foods">
                <img src="https://media.istockphoto.com/id/1262305920/photo/tea-time-snack-dal-vada-or-parippu-vada-or-paruppu-vadai-deep-fried-snacks-savory-food-from.jpg?s=612x612&w=0&k=20&c=Dxeb2eSaXCiumc_muijW3R-T7GBNnSxVuc0J0LS3DOo=" alt="#" height="200" width="250" />
                <h4>MEDHU VADA</h4>
                <h4>Rs.20</h4>
                <button className='btn btn-primary'><i class="bi bi-bag-heart-fill">Buy Now</i></button>
            </div>
