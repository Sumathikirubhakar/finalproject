...
export default function Brandstory() {
    return (
        <div>
            <div>
                <img src="https://www.nh-hotels.com/nhpro/assets/uploads/2024/08/20132457/nhow_Frankfurt_Lobby_and_reception_empty_lamps_counter_flowers-8256x5504-1-1920x1280.jpg" alt="noimage" height="500" width="100%" />
            </div>
            <div class="brandh3">
