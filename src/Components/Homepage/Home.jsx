...
export default function Home() {
    return (
        <div className='homepage'>
            ...
            <Carousel>
                <Carousel.Item>
                    <img src="southtraditionalfood.png" alt="noimage" height={600} width={1680} />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img src="northtraditionalfood.png" alt="noimage" height={600} width={1680} />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img src="tandooritraditional.png" alt="noimage" height={600} width={1680} />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img src="teateasnacks.png" alt="noimage" height={600} width={1680} />
                    <Carousel.Caption>
                ...
                <Carousel.Item>
                    <img src="juices.png" alt="noimage" height={600} width={1680} />
                    <Carousel.Caption>
